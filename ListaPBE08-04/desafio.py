    ...
    if iniciar == 1:
        ...
        while True:
            ...
            itens = int(input("Caso queira, utilize um item: \n"
                              "Romã do castelo do fogo branco (Sua vida máxima aumenta em 10%) [1]\n"
                              ...
                              "Autoridade do monarca (Use apenas em uma situação emergencial!)"))#Segunda vida, mas com apenas 20% da vida máxima
