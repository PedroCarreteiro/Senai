            ...
            while True:
                ...
                if azul_selecionado_jogador_1:
                    ...
                    while contador_azul_jogador_1 != 2:
                        ...
                        print(f"--- Turno {turno} ---\n"
                              f"Seu HP: {vida_jogador_1} | Inimigo HP: {vida_jogador_2}")

                        if loop_selecionado_jogador_2:
                            print("O jogador 2 reiniciou seu sistema!")
                        ...
                        if opcao == 1:
                            ...
                            # Resultado do ataque do jogador
                            ataque_jogador = dano_jogador_1 - defesa_jogador_2
                            ...
                            # Atualizar a vida da cpu
                            vida_jogador_2 = vida_jogador_2 - ataque_jogador
                        ...
                        # Se o loop_jogador_1 for selecionado
                ...
                # Se efeito 3 selecionado
                    ...
                    if azul_jogador_1:
                        ...
                        print("Tela azul_jogador_1 utilizada!")
                    else:
                        print("Você já utilizou esse efeito este jogo!")
